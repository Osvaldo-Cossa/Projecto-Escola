 ...
 * @author Mr. Savagery
 */
public class estUpdateForm extends javax.swing.JFrame {

    /**
     * Creates new form estUpdateForm
     */
    public estUpdateForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Codigo do Estudante a editar:");
        ...
        jLabel4.setText("Nome do Estudante Actualizado:");
        ...
        jLabel5.setText("Ano de Ingresso Actualizado:");
    ...
    private void atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarActionPerformed
        try {
            ...
            estudante.setCodigo(Integer.parseInt(codigoField.getText()));
            if(control.update(estudante)){
                JOptionPane.showMessageDialog(null, "Dados Atualizados");dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Erro");dispose();
            }
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(estUpdateForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estUpdateForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
